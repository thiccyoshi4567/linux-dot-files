...
" Always show 20 lines on top and below cursor
set scrolloff=20
...
" Enable highlighting during a search
set hlsearch

" Map the escape key to unhighlight search terms temporarily
map <esc> :noh <CR>

" Enable tab completion
set wildmenu

" Change tab completion to behave like bash
set wildmode=list:longest

" Disable editing files with certain file extensions
